...
/// <reference path="KeyboardHandler.js" />
...
$(window).ready(function () { 
    ...
    (function (window) {
        ...
        var dispatchTextEvent = function (target, type, data) {
            ...
            t.initTextEvent(textInputName, true, true, document.defaultView, data, 1, "");
        ...
        var keyProperties = ["which", "altKey", "shiftKey", "ctrlKey", "char", "charCode", "key", "keyCode", "data", "repeat", "locale", "location", "keyIdentifier"];
        ...
        var copyKeyProperties = function (src, dest) {
            ...
            if (src.originalEvent) {
                copyKeyProperties(src.originalEvent, dest);
            }
            return dest;
        };
